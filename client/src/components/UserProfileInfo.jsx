...
import { Calendar, CalendarClock, Icon, MapPin, Pen, Verified } from 'lucide-react'
  ...
  return (
    <div className='relative py-4 px-6 md:px-8 bg-white '>
        <div className='flex flex-col md:flex-row items-start gap-6'>
            <div className='w-32 h-32 border-4 border-white absolute shadow-lg -top-16 rounded-full '>
