...
const Messages = () => {
  ...
  return (
    ...
    <div className='min-h-screen relative bg-slate-50 ml-60 xl:ml-72'>
        ...
        {/* Title  */}
          ...
          <div className='flex flex-col gap-3'>
            {connections.map((user) => (
             ...
             {/* <div key={user._id} className="max-w-xl flex items-start gap-4 p-6 bg-white shadow rounded-md"> */}
